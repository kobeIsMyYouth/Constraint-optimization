...
for p in ps:
    ...
    if p == "C01":
        ...
        G, cp, e = C09, 5, 0.00001
    elif p == "C10":
        G, cp, e = C10, 5, 0.00001
    elif p == "C11":
        G, cp, e = C11, 5, 0.00000001
    elif p == "C12":
        G, cp, e = C12, 5, 1
    elif p == "C13":
        G, cp, e = C13, 5, 1
    ...
    for n in range(25):
        ...
        P = myDE_fit.DE(40, 4, d, 200000, G, 0.7, 0.9, cp, e, 3, 1, 0)
        P.init_Population()
