...
for n in range(25):
    ...
    P = myDE_fit.DE(40, 4, 10, 200000, C15, 0.7, 0.9, 5, 0.001, 0, 0, 0)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, C15.f, d)
result2 = statics.st1(solutions2, fitnesses2, C15.f, d)
result3 = statics.st1(solutions3, fitnesses3, C15.f, d)
