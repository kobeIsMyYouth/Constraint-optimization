...
ps = ["C02", "C03", "C04", "C05", "C06", "C07", "C08", "C09", "C10", "C11", "C12", "C13", "C14",
...
for p in ps:
    ...
    for n in range(25):
        ...
        P = DE_com.DE(40, 4, d, 1000000, G, 3, 0, 5, 0.7, 0.9, 5)
        P.init_Population()
        gbest_1, g_fit_1, gbest_2, g_fit_2, gbest_3, g_fit_3, FES, devi, fe, su = P.iterator()

        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_3/gbest_" + str(n) + "_1.txt", gbest_1)
        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_3/g_fit_" + str(n) + "_1.txt", g_fit_1)
        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_4/gbest_" + str(n) + "_2.txt", gbest_2)
        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_4/g_fit_" + str(n) + "_2.txt", g_fit_2)
        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_5/gbest_" + str(n) + "_3.txt", gbest_3)
        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_5/g_fit_" + str(n) + "_3.txt", g_fit_3)

        np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_" + str(n) + ".txt", [FES])
    ...
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_3/solutions.txt", solutions1)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_3/fitnesses.txt", fitnesses1)

    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_4/solutions.txt", solutions2)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_4/fitnesses.txt", fitnesses2)

    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_5/solutions.txt", solutions3)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/FES_5/fitnesses.txt", fitnesses3)

    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/fes.txt", fes)
    ...
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/res0.txt", result0)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/res1.txt", result1)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/res2.txt", result2)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/res3.txt", result3)
    np.savetxt("./results/d="+str(d)+"/epsilon/" + p + "/res4.txt", result4)
