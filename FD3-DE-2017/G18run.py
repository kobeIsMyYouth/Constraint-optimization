...
for n in range(25):
    ...
    P = myDE_fit.DE(40, 4, d, 2000000, C18, 0.7, 0.9, 5, 0.000001, 3, 1, 0)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, C18.f, d)
result2 = statics.st1(solutions2, fitnesses2, C18.f, d)
result3 = statics.st1(solutions3, fitnesses3, C18.f, d)
