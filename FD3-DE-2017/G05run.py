...
for n in range(25):
    ...
    P = myDE_fit.DE(40, 4, 30, 600000, C05, 0.7, 0.9, 5, 1, 0, 0, 0)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, C05.f, d)
result2 = statics.st1(solutions2, fitnesses2, C05.f, d)
result3 = statics.st1(solutions3, fitnesses3, C05.f, d)
