...
for n in range(25):
    ...
    P = myDE_fit.DE(40, G12.dim, 12500, G12, 0.7, 0.9, 5, 1)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, G12.f)
result2 = statics.st1(solutions2, fitnesses2, G12.f)
result3 = statics.st1(solutions3, fitnesses3, G12.f)
