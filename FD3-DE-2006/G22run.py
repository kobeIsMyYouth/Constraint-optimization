...
for n in range(25):
    ...
    P = myDE_fit.DE(40, G22.dim, 12500, G22, 0.7, 0.9, 0, 0.0001)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, G22.f)
result2 = statics.st1(solutions2, fitnesses2, G22.f)
result3 = statics.st1(solutions3, fitnesses3, G22.f)
