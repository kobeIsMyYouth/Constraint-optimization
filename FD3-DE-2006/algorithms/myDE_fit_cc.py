...
class DE():
    ...
    def init_Population(self):
        ...
        for i in range(self.pN):
            ...
            fitness, y, v = fit_vio2.fit1(self.G.f, self.X[i], self.G.fmax, self.G.fmin, self.G.vmax, self.e)
            self.Xfv[i] = fitness
    ...
    def iterator(self):
        ...
        for t in range(self.tmax):
            ...
            for i in range(self.pN):
                ...
                X_new_fitness, y, v = fit_vio2.fit1(self.G.f, X_new, self.G.fmax, self.G.fmin, self.G.vmax, ee)
