...
for n in range(25):
    ...
    P = myDE_fit.DE(40, G17.dim, 12500, G17, 0.7, 0.9, 0.1, 0.2)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, G17.f)
result2 = statics.st1(solutions2, fitnesses2, G17.f)
result3 = statics.st1(solutions3, fitnesses3, G17.f)
