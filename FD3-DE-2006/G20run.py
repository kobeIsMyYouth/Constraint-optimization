...
for n in range(25):
    ...
    P = myDE_fit.DE(40, G20.dim, 1250000, G20, 0.7, 0.9, 0, 1)
    P.init_Population()
...
result1 = statics.st1(solutions1, fitnesses1, G20.f)
result2 = statics.st1(solutions2, fitnesses2, G20.f)
result3 = statics.st1(solutions3, fitnesses3, G20.f)
